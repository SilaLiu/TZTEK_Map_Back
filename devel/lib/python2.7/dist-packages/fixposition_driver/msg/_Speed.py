...
"""autogenerated by genpy from fixposition_driver/Speed.msg. Do not edit."""
import codecs
import sys
...
class Speed(genpy.Message):
  _md5sum = "00264f61d2b8d6e211424a49de9947b3"
  _type = "fixposition_driver/Speed"
...
"""
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.speeds = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
